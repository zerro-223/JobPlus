...
(6, '华为技术有限公司',       '华为',     '通信/IT',   '1000人以上',   '华为是全球领先的ICT基础设施和智能终端提供商，致力于把数字世界带入每个人。', 'https://www.huawei.com', '深圳市龙岗区坂田华为基地', '李经理', '0755-88888888', 1),
(7, '北京字节跳动科技有限公司', '字节跳动', '互联网',   '1000人以上',   '字节跳动旗下拥有抖音、今日头条等产品，致力于成为全球创作与交流平台。', 'https://www.bytedance.com', '北京市海淀区知春路48号', '王经理', '010-88888888', 1);
...
(1, 6, 'Java 高级开发工程师',
 '负责阿里云核心产品的后端设计与开发，参与系统架构设计，优化系统性能。参与 Code Review，指导初中级工程师。',
...
(2, '张三', '男', '1998-05-15', '13800000001', 'candidate1@test.com', '本科', '浙江大学', '计算机科学与技术', '2020',
 '5年Java开发经验，参与过多个大型分布式项目。熟悉Spring全家桶、微服务架构，具备良好的团队协作和沟通能力。',
...
(1, '浙江大学', '计算机科学与技术', '本科', '2016-09', '2020-06', 'GPA 3.8/4.0，获校级优秀毕业生。ACM校队成员，获区域赛银奖。', 1),
(2, '杭州电子科技大学', '软件工程', '本科', '2018-09', '2022-06', 'GPA 3.6/4.0，校优秀学生干部。', 1),
(3, '北京大学', '计算机技术', '硕士', '2021-09', '2024-06', '研究方向NLP，在ACL 2023发表论文一篇。', 1),
(3, '武汉大学', '计算机科学与技术', '本科', '2017-09', '2021-06', 'GPA 3.7/4.0，校级奖学金。', 2);

-- 工作经历
INSERT INTO work_experience (resume_id, company, position, start_date, end_date, description, sort_order) VALUES
(1, '网易', 'Java开发工程师', '2020-07', '2023-12', '负责网易云音乐后端服务开发，参与微服务架构升级项目。', 1),
(1, '蚂蚁集团', '高级Java开发', '2024-01', '2026-05', '负责支付宝核心支付链路开发与优化，日均处理亿级交易。', 2),
(2, '有赞科技', '前端开发实习生', '2021-07', '2022-06', '参与有赞小程序前端开发，使用React+TypeScript技术栈。', 1),
(2, '拼多多', '前端开发工程师', '2022-07', '2026-05', '负责商家端Web开发，参与组件库建设和前端性能优化。', 2);

-- 项目经验
INSERT INTO project_experience (resume_id, name, role, start_date, end_date, description, sort_order) VALUES
(1, '分布式消息系统', '核心开发', '2022-03', '2022-09', '基于RocketMQ的消息处理平台，支持日吞吐量百亿级，采用分库分表方案。', 1),
(2, '电商后台管理系统', '前端负责人', '2023-01', '2023-06', '使用React+Ant Design搭建的B端管理平台，支持数据可视化大屏。', 1),
(3, '多语言文本摘要系统', '核心算法', '2022-09', '2023-12', '基于Transformer的多语言文本摘要模型，在中文数据集上达到SOTA。发表ACL 2023论文。', 1);
