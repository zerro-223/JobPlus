...
(3, '李四', '男', '2000-03-20', '13800000002', 'candidate2@test.com', '本科', '杭州电子科技大学', '软件工程', '2022',
 '有前端开发和全栈项目经验。', 'JavaScript,TypeScript,React,Vue.js,Node.js,Python', 1),
(4, '王五', '女', '1999-11-08', '13800000003', 'candidate3@test.com', '硕士', '北京大学', '计算机技术', '2024',
 '应届硕士，研究方向为自然语言处理。', 'Python,PyTorch,TensorFlow,NLP,Deep Learning,SQL', 1);
...
-- 工作经历（position是MySQL关键字，加反引号转义列名）
